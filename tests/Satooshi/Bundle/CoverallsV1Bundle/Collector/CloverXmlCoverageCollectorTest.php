...
<coverage generated="1365848893">
  <project timestamp="1365848893">
    ...
    <package name="Hoge">
      ...
      <file path="%stest3.php" name="test3.php">
...
XML;
        ...
        return simplexml_load_string(sprintf($xml, $srcDirSeparator, $srcDirSeparator, $srcDirSeparator, $srcDirSeparator));
    }
    ...
    public function shouldCollectSourceFileTest1(JsonFile $jsonFile)
    {
        ...
        $name1 = 'test.php';
        $path1 = $this->getSrcDirSeparator() . $name1;
    ...
    public function shouldCollectSourceFileTest2(JsonFile $jsonFile)
    {
        ...
        $name2 = 'test2.php';
        $path2 = $this->getSrcDirSeparator() . $name2;
