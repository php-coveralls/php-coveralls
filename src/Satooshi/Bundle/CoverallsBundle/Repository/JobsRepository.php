...
namespace Satooshi\Bundle\CoverallsBundle\Repository;

use GuzzleHttp\Psr7\Response;
use Psr\Log\LoggerAwareInterface;
use Psr\Log\LoggerInterface;
use Satooshi\Bundle\CoverallsBundle\Api\Jobs;
use Satooshi\Bundle\CoverallsBundle\Config\Configuration;
...
class JobsRepository implements LoggerAwareInterface
{
     ...
     * Jobs API.
     *
     * @var \Satooshi\Bundle\CoverallsBundle\Api\Jobs
     */
    protected $api;
     ...
     * Configuration.
     *
     * @var \Satooshi\Bundle\CoverallsBundle\Config\Configuration
     */
    protected $config;
