...
use Satooshi\Bundle\CoverallsBundle\Entity\Exception\RequirementsNotSatisfiedException;
...
class JsonFile extends Coveralls
{
     ...
     * Source files.
     *
     * @var \Satooshi\Bundle\CoverallsBundle\Entity\SourceFile[]
     */
    ...
    public function reportLineCoverage()
    {
        ...
        foreach ($this->sourceFiles as $sourceFile) {
            /* @var $sourceFile \Satooshi\Bundle\CoverallsBundle\Entity\SourceFile */
     ...
     * @param string $path absolute path to source file
     *
     * @return \Satooshi\Bundle\CoverallsBundle\Entity\SourceFile|null
     */
     ...
     * Return source files.
     *
     * @return \Satooshi\Bundle\CoverallsBundle\Entity\SourceFile[]
     */
     ...
     * Return metrics.
     *
     * @return \Satooshi\Bundle\CoverallsBundle\Entity\Metrics
     */
