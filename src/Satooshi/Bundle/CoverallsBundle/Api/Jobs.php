...
namespace Satooshi\Bundle\CoverallsBundle\Api;

use Satooshi\Bundle\CoverallsBundle\Collector\CiEnvVarsCollector;
use Satooshi\Bundle\CoverallsBundle\Collector\CloverXmlCoverageCollector;
use Satooshi\Bundle\CoverallsBundle\Collector\GitInfoCollector;
use Satooshi\Bundle\CoverallsBundle\Entity\JsonFile;
...
class Jobs extends CoverallsApi
{
     ...
     *
     * @throws \Satooshi\Bundle\CoverallsBundle\Entity\Exception\RequirementsNotSatisfiedException
     *
     * @return $this
     */
    public function collectEnvVars(array $env)
    {
        ...
        } catch (\Satooshi\Bundle\CoverallsBundle\Entity\Exception\RequirementsNotSatisfiedException $e) {
