        ...
        $rootNode
            ->children()
                ...
                ->variableNode('coverage_clover')
                    ->defaultValue('build' . DIRECTORY_SEPARATOR . 'logs' . DIRECTORY_SEPARATOR . 'clover.xml')
                ->end()
                ->scalarNode('json_path')
                    ->defaultValue('build' . DIRECTORY_SEPARATOR . 'logs' . DIRECTORY_SEPARATOR . 'coveralls-upload.json')
                ->end()
